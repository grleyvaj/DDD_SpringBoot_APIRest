 ...
 * Build the content of a messahe, header or body of a ResponseEntity to Error Exception.
...
public class ErrorContentHandler {
    ...
    public HttpHeaders unProcessableEntityAlert(String errorMessage) {
        return createHeaders(UNPROCESSABLE_ENTITY, errorMessage);
    }

    public String unProcessableEntityAlertMessage(String resourceName, String fieldName, String fieldValue) {
        return head(resourceName, fieldName, fieldValue) + env.getProperty("id.invalid");
    }
